...
import { Flex, Textarea, Radio, Group, TextInput, Grid, Paper, Box, Title, Text, Button, Stack, Card } from '@mantine/core';
...
>
  ...
  >
    <Flex direction="column" style={{ padding: '2rem', height: "100%" }}>
      <Title order={1} ta="center">Confirmation</Title>

      {!pending && (
        <Text mt="md">No pending booking found. Go back to schedule to select a time.</Text>
      )}
        ...
        <Box mt="md" style={{ flex: 1 }}>
          ...
          <Flex align="center" mt="md" gap="md">
            ...
            <Paper shadow="none" radius="lg" p="xs" bg="#ededed" style={{ flex: 1 }}>
              <Text ta="left" weight={500}>{pending.patientName}</Text>
            </Paper>
          </Flex>
          ...
          <Flex align="center" mt="md" gap="md">
            ...
            <Paper shadow="none" radius="lg" p="xs" bg="#ededed" style={{ flex: 1 }}>
              <Text ta="left" weight={500}>{pending.duration} minutes</Text>
            </Paper>
          </Flex>
          ...
          <Flex align="center" mt="md" gap="md">
            ...
            <Paper shadow="none" radius="lg" p="xs" bg="#ededed" style={{ flex: 1 }}>
              <Text ta="left" weight={500}>{pending.appointmentType}</Text>
            </Paper>
          </Flex>
          ...
          <Flex align="center" mt="md" gap="md">
            ...
            <Paper shadow="none" radius="lg" p="xs" bg="#ededed" style={{ flex: 1 }}>
              <Text ta="left" weight={500}>{pending.doctorName.slice(0,-2)}</Text>
            </Paper>
          </Flex>
        </Box>
      )}
      ...
      <Flex gap="md" justify="flex-end">
        ...
        <Button size="lg" disabled={!pending} onClick={handleConfirm}>Confirm Appointment</Button>
      </Flex>
    </Flex>
  </Card>
</Box>
